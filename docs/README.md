...
| [../app/src/features/dashboard/DashboardPage.tsx](../app/src/features/dashboard/DashboardPage.tsx), [DashboardPage.css](../app/src/features/dashboard/DashboardPage.css) and [dashboard components](../app/src/features/dashboard/components/SailingHero.tsx) | Dashboard feature | Implement the cinematic active-sailing hero, route ribbon, metrics and six voyage-readiness cards as maintainable React components. |
...
| [../app/src/features/today/TodayPage.tsx](../app/src/features/today/TodayPage.tsx), [TodayPage.css](../app/src/features/today/TodayPage.css) and [Today components](../app/src/features/today/components/TodayAshorePanel.tsx) | Today feature | Implement the pre-cruise companion state, five-second operational summary, prominent all-aboard time, return buffer, weather readiness, plan, checklist, Seb discovery and confidence notes. |
