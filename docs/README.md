...
| [../app/src/routes/routeConfig.ts](../app/src/routes/routeConfig.ts) and [data/sampleData.ts](../app/src/data/sampleData.ts) | App routing | Define eleven implemented hash routes across Dashboard, Itinerary, Setup, Enrichment, Today, Ports, Ship, Plans, Family, Memories and Import / Export while retaining shell metadata placeholders. |
