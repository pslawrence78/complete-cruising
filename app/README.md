...
This directory contains the tested Vite, React and TypeScript application through Tranche 23, including the Ocean Luxe experience, Zod-backed canonical data, local Dexie persistence, production PWA app-shell readiness, GitHub Pages deployment readiness, production-smoke release hardening, real Sun Princess 2026 onboarding, guarded Data Safety, managed sailing setup, governed enrichment request generation, six-type return-schema import routing, MVP cruise usability polish, the Cartographic Port Atlas, the cruise weather intelligence layer, trust-aware manual Open-Meteo refresh and the derived day-readiness surfaces.
