...
This directory contains the tested Vite, React and TypeScript application through Tranche 17, including the Ocean Luxe experience, Zod-backed canonical data, local Dexie persistence, production PWA app-shell readiness, GitHub Pages deployment readiness, production-smoke release hardening, sailing setup and enrichment request generation.
